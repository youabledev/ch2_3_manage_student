...
import org.fastcampus.student_management.domain.Fee;
...
public class CourseService {
  ...
  public void changeFee(String studentName, int fee) {
    List<Course> courses = courseRepository.getCourseListByStudent(studentName).stream()
        .map((Course course) -> course.changeFee(new Fee(fee)))
        .toList();
